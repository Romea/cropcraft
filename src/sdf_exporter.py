...
def create_sdf_link(model: ET.Element, object: bpy.types.Object):
    ...
    if diffuse_map != "":
        ...
        albedo_map.text = MESHES_DIR_PREFIX + diffuse_map
...
def create_config(model_name, sdf_filename):
    ...
    name.text = "Generated by blender script"
...
def export_sdf(prefix_path):
    ...
    for object in bpy.data.collections['export'].all_objects.values():
        if object.type == 'MESH':
            ...
            # export_mesh(prefix_path + MESHES_DIR_PREFIX + object.name)
    ...
    # create config file
    model = create_config(model_name, sdf_filename)
