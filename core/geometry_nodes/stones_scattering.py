...
def stones_scattering_node_group():
	...
	musgrave_texture = scattering.nodes.new("ShaderNodeTexMusgrave")
	...
	# Vector
	musgrave_texture.inputs[0].default_value = (0.0, 0.0, 0.0)
	# Detail
	musgrave_texture.inputs[3].default_value = 7.09999942779541
	# Dimension
	musgrave_texture.inputs[4].default_value = 0.9000000953674316
	# Lacunarity
	musgrave_texture.inputs[5].default_value = 2.599998712539673
	# Gain
	...
	musgrave_texture.location = (-425.44464111328125, -26.346969604492188)
	...
	# musgrave_texture.Fac -> distribute_points_on_faces.Density Factor
	scattering.links.new(musgrave_texture.outputs[0], distribute_points_on_faces.inputs[5])
	...
	# group_input_002.Seed -> musgrave_texture.W
	scattering.links.new(group_input_002.outputs[3], musgrave_texture.inputs[1])
	...
	# group_input_002.Noise Scale -> musgrave_texture.Scale
	scattering.links.new(group_input_002.outputs[6], musgrave_texture.inputs[2])
	# group_input_002.Noise Offset -> musgrave_texture.Offset
	scattering.links.new(group_input_002.outputs[7], musgrave_texture.inputs[6])
