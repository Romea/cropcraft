...
def export_images(filepath: str):
    for image in bpy.data.images:
        if image.has_data:
            image.save(filepath=os.path.join(filepath, image.name))
