...
def export_sdf(prefix_path):
    ...
    for l in light_objects:
        ...
        if blender_light.type == "POINT":
            ...
            diffuse.text = str(blender_light.color.r) + " " + str(
                blender_light.color.g) + " " + str(blender_light.color.b) + " 1.0"
        ...
        if blender_light.type == "SUN" or blender_light.type == "SPOT":
            ...
            direction.text = str(l.matrix_world[0][2]) + " " + str(
                l.matrix_world[1][2]) + " " + str(l.matrix_world[2][2])
...
if __name__ == "__main__":
    export_sdf(bpy.path.abspath('//gazebo/'))
